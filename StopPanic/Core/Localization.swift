...
enum L10n {
    ...
    enum Onboarding {
        ...
        static let medicalDisclaimer = String(localized: "onboarding.disclaimer", defaultValue: "StopPanic — помощник, НЕ замена врачу. При подозрении на сердечную проблему всегда вызывайте скорую.")
    }
    ...
    static func greeting(name: String) -> String {
        ...
        switch hour {
        case 5..<12:
            timeGreeting = String(localized: "greeting.morning", defaultValue: "Доброе утро")
        case 12..<17:
            timeGreeting = String(localized: "greeting.afternoon", defaultValue: "Добрый день")
        case 17..<22:
            timeGreeting = String(localized: "greeting.evening", defaultValue: "Добрый вечер")
        default:
            timeGreeting = String(localized: "greeting.night", defaultValue: "Спокойной ночи")
        }
