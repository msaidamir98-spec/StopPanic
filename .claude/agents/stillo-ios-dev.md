...
- `/Users/msk/obsiddian/StopPanic/System/Антипаттерны.md` — 20+ известных багов, нельзя повторять
- `/Users/msk/obsiddian/StopPanic/System/🧠 Конституция AI-Агента.md` — общие правила
...
1. **ВСЕГДА сначала** прочитай `/Users/msk/obsiddian/StopPanic/System/Текущий Статус.md` чтобы понимать актуальный фазовый статус.
